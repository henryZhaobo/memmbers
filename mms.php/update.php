...
<input type="hidden" name=pwd2 value=<?php echo $data[0]->pwd;?> class="form-control">
用户名：<input type="text" name="username" value=<?php echo $data[0]->username;?> class="form-control"><br>
密码：<input type="password" name="pwd" value=<?php echo $data[0]->pwd;?> class="form-control"><br>
email：<input type="text" name="email" value=<?php echo $data[0]->email;?> class="form-control"><br>
